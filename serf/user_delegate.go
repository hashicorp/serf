...
func (s *Agent) NodeMeta(limit int) []byte {
...
func (s *Agent) NotifyMsg(buf []byte) {
	if len(buf) == 0 {
		return
	}
...
func (s *Agent) MergeRemoteState(buf []byte) {
